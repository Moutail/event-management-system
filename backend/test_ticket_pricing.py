#!/usr/bin/env python
"""
🧪 TEST DU SYSTÈME DE FACTURATION DES TYPES DE BILLETS
"""
...
def test_ticket_pricing_system():
    """Tester le système de facturation des types de billets"""
    print("🧪 TEST DU SYSTÈME DE FACTURATION DES TYPES DE BILLETS")
    print("=" * 70)
    ...
    try:
        ...
        user, created = DjangoUser.objects.get_or_create(
            username='test_ticket_pricing',
            defaults={
                'email': 'test@pricing.com',
                'first_name': 'Test',
                'last_name': 'Pricing'
            }
        )
        ...
        event, created = Event.objects.get_or_create(
            title='Test Facturation Types de Billets',
            defaults={
                'description': 'Événement pour tester la facturation des types de billets',
        ...
        registration_data = {
            ...
            'guest_email': 'standard@example.com',
            'guest_first_name': 'Test',
        ...
        registration_data = {
            ...
            'guest_email': 'remise@example.com',
            'guest_first_name': 'Test',
        ...
        registration_data = {
            ...
            'guest_email': 'default@example.com',
            'guest_first_name': 'Test',
