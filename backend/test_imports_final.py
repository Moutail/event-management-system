#!/usr/bin/env python
"""
Test final des imports pour vérifier que tout fonctionne
"""
import os
import sys
import django
...
try:
    ...
    print("✅ Import EventViewSet réussi")
except ImportError as e:
    print(f"❌ Erreur import EventViewSet: {e}")
...
print("✅ Test final des imports terminé")
