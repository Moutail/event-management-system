...
def test_final():
    ...
    try:
        ...
        print(f"   Meeting Password AVANT: {virtual_event.meeting_password}")
        ...
        try:
            ...
            if result.get('success'):
                ...
                print(f"   Meeting Password APRÈS: {virtual_event.meeting_password}")
